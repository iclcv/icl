...
if(ICL_VAR_DEBUG_MODE)
  if(ICL_VAR_ARCHITECTURE_DEPENDENT_BUILD_ON)
    set(CMAKE_CXX_FLAGS "-Wall -O0 -g3 -march=native ${ICL_DEACTIVATED_WARNING}")
  else()
    set(CMAKE_CXX_FLAGS "-Wall -O0 -g3 ${ICL_DEACTIVATED_WARNING}")
  endif()
  ...
  if(ICL_VAR_ARCHITECTURE_DEPENDENT_BUILD_ON)
    set(CMAKE_CXX_FLAGS "-O3 -march=native ${ICL_DEACTIVATED_WARNING}")
  else()
    set(CMAKE_CXX_FLAGS "-O3 ${ICL_DEACTIVATED_WARNING}")
  endif()

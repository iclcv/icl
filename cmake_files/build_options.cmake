...
if(ICL_VAR_DEBUG_MODE)
  if(ICL_VAR_ARCHITECTURE_DEPENDENT_BUILD_ON)
    set(CMAKE_CXX_FLAGS "-Wall -O0 -g3 -march=native -Wno-internal-linkage-in-inline -Werror -Wno-\\#warnings -Wno-deprecated-declarations -Wno-uninitialized -Wno-overloaded-virtual")
  else()
    set(CMAKE_CXX_FLAGS "-Wall -O0 -g3 -Wno-internal-linkage-in-inline -Werror -Wno-\\#warnings -Wno-deprecated-declarations -Wno-uninitialized -Wno-overloaded-virtual")
  endif()

...
void init(){
  ...
  gui << Canvas().minSize(32,24).label("image").handle("image")
      << ( VBox().label("Region information")
           ...
           << ( HBox()
                << CheckBox("show boundary",true).handle("showBoundary")
                << Button("normal","!thinned").handle("showThinnedBoundary")
                )
           << ( HBox()
                << CheckBox("show sub regions",true).handle("showSubRegions")
                << Button("direct","all").handle("showAllSubRegions")
                )
           << ( HBox()
                << CheckBox("show sur. regions",true).handle("showSurRegions")
                << Button("direct","all").handle("showAllSurRegions")
                )
           << ( HBox()
           ...
           << ( HBox()
                << Button("stopped","!grabbing").handle("grabbing").minSize(3,2)

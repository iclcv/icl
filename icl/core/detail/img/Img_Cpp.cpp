...
#undef ICL_INSTANTIATE_DEPTH
  ...
  // ================================================================
  // replicateBorder — extrude ROI edges into the border pixels
  // ================================================================
  ...
  inline void copy_border(Img<T> *poImage){
    ...
    for (int c = 0; c < poImage->getChannels(); c++) {
      aPix[0] = (*poImage)(roi.x,         roi.y,          c);
      aPix[1] = (*poImage)(roi.right()-1, roi.y,          c);
      aPix[2] = (*poImage)(roi.right()-1, roi.bottom()-1, c);
      aPix[3] = (*poImage)(roi.x,         roi.bottom()-1, c);
...
#undef ICL_INSTANTIATE_DEPTH
  ...
  static int _reg = [] {
    ...
    cpp.add<ImgOps::ReplicateBorderSig>(Op::replicateBorder, cpp_replicateBorder, "C++ border replication");

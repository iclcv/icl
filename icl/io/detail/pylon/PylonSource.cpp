...
#include <icl/io/detail/pylon/PylonSource.h>
...
void PylonSource::grabbingStart(){
  FUNCTION_LOG("");
...
void PylonSource::cameraDefaultSettings(){
...
const core::ImgBase* PylonSource::acquireImage(){

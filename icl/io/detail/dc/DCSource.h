...
// Copyright (C) 2006-2026 Christof Elbrechter, Michael Goetting, Viktor Richter
  ...
  */
  class DCSource : public SourceBackend{
    public:
      ...
      /// Constructor creates a new DCSource instance from a given DCDevice
      /** @param dev DCDevice to use (this device can only be created by the
        ...
        */
      ICLIO_API DCSource(const DCDevice &dev=DCDevice::null, int isoMBits=0);

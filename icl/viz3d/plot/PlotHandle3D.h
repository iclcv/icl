...
#include <icl/viz3d/plot/PlotWidget3D.h>

namespace icl::viz3d {

  /// Handle for the viz3d Plot3D GUI component \ingroup HANDLES
  class ICLViz3d_API PlotHandle3D : public qt::GUIHandle<PlotWidget3D> {
  public:
    PlotHandle3D() {}

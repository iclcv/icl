...
//
//   QT_QPA_PLATFORM=cocoa builddir/bin/viz3d-plot-frame-capture-demo \
...
int main(int argc, char **argv) {
  ...
  frame->addChild(icl::viz3d::detail::makePlotBox());
  std::shared_ptr<GroupNode> axes[3] = {
    icl::viz3d::detail::makePlotAxis(Range32f(-4, 4), false, "X"),
    icl::viz3d::detail::makePlotAxis(Range32f(-4, 4), false, "Y"),
    icl::viz3d::detail::makePlotAxis(Range32f(-4, 4), false, "Z"),
  };
  // ticks on the edges meeting at the corner furthest from the camera
  icl::viz3d::detail::placePlotAxes(axes, pos[0] > 0 ? -1 : 1,

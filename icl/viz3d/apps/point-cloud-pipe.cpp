...
// point-cloud-pipe (viz3d): grab a depth/RGBD image stream, reconstruct the
...
void run() {
  ...
  if      (mode == 1) cloud->filterDepthRange(src.getCamera(), gui["dmin"], gui["dmax"]);

...
namespace icl::viz3d {
  ...
  class ICLViz3d_API BVHSceneCapture : public SceneCapture {
  public:
    BVHSceneCapture();
  ...
  class ICLViz3d_API GLSceneCapture : public SceneCapture {
  public:

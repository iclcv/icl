...
// renders a built-in geom2 scene. It lets the depth-camera / point-cloud apps
...
namespace icl::geom2 {
  ...
  REGISTER_SOURCE_BACKEND(scene, createScene, getSceneDeviceList,
      "scene preset (optional)~synthetic depth/RGBD/color camera over a built-in geom2 scene")

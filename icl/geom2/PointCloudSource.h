...
namespace icl::geom2 {
  ...
  /// Turns an image-based depth/RGBD ImageSource into geom2 point clouds.
  /** The geom2/ImageSource counterpart of the legacy GenericPointCloudGrabber:
  ...
  class ICLGeom2_API PointCloudSource {
  public:
    PointCloudSource();
    ~PointCloudSource();

...
// point-cloud-define-world-frame (geom2): interactively define a depth camera's
// world frame by clicking a flat surface. A ray-cast (RayCastOctree filled from
// the geom2 PointCloud) finds the clicked 3D point; the surrounding segmented
...
// the point-cloud/scene plumbing moved to geom2 (PointCloudSource +

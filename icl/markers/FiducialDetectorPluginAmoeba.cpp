...
#include <icl/markers/TwoLevelRegionStructure.h>
...
namespace icl::markers {
  ...
  void FiducialDetectorPluginAmoeba::addOrRemoveMarkers(bool add, const std::string &which, const ParamMap &params){
    File f(which);

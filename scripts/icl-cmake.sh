...
ICL_VAR_INSTALL_PREFIX=/vol/nivision/ICL/${ICLVER}${VERSION_POSTFIX}
ICL_XDEP_IPP_PATH=/vol/nivision/share/IPP/6.0
ICL_XDEP_MKL_PATH=/vol/nivision/share/MKL/10.2
ICL_XDEP_LIBDC_PATH=/usr
ICL_XDEP_LIBMESASR_PATH=/usr
ICL_XDEP_XCF_PATH=/vol/xcf
ICL_XDEP_OPENCV_PATH=/vol/nivision/OpenCV2
...
cd build/${VERSION}
${PROG} -D ICL_XDEP_ALL_ON:BOOL=TRUE -D ICL_XDEP_IPP_PATH:STRING=${ICL_XDEP_IPP_PATH} -D ICL_XDEP_MKL_PATH:STRING=${ICL_XDEP_MKL_PATH} -D ICL_XDEP_XCF_PATH:STRING=${ICL_XDEP_XCF_PATH} -D ICL_VAR_INSTALL_PREFIX:STRING=${ICL_VAR_INSTALL_PREFIX} -D ICL_VAR_DEBUG_MODE:BOOL=${DEBUG_VALUE} -D ICL_XDEP_OPENCV_PATH:STRING=${ICL_XDEP_OPENCV_PATH} -D ICL_XDEP_LIBDC_PATH:STRING=${ICL_XDEP_LIBDC_PATH} -D ICL_XDEP_LIBMESASR_PATH:STRING=${ICL_XDEP_LIBMESASR_PATH} -D ICL_XDEP_OPENCV_ON:BOOL=${ICL_XDEP_OPENCV_ON} -D ICL_XDEP_XCF_ON:BOOL=${ICL_XDEP_XCF_ON} ../../

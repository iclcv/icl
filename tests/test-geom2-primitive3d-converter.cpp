...
// nodeFromPrimitive3D — the geom2 replacement for Primitive3D::toSceneObject:
...
ICL_REGISTER_TEST("geom2.primitive3d.cube", "nodeFromPrimitive3D(CUBE) → CuboidNode + pose")
{
...
ICL_REGISTER_TEST("geom2.primitive3d.sphere", "nodeFromPrimitive3D(SPHERE) → SphereNode radii=scale/2")
{
...
ICL_REGISTER_TEST("geom2.primitive3d.cylinder", "nodeFromPrimitive3D(CYLINDER) → CylinderNode")
{

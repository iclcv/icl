...
namespace icl{  
  ...
  namespace qt{
    ...
    */
    struct ICL_QT_API Button : public GUIComponentWithOutput{
      private:
      /// utility method
    ...
    struct ICL_QT_API ButtonGroup : public GUIComponentWithOutput{
    ...
    struct ICL_QT_API CheckBox : public GUIComponentWithOutput{
    ...
    struct ICL_QT_API Label : public GUIComponent{
    ...
    struct ICL_QT_API Slider : public GUIComponentWithOutput{
    ...
    /** Creates a FSliderHandle and an float-valued ouptut that contains the current slider value.
        Sliders always come with an QLCDNumber component, that displays the current slider value */
    struct ICL_QT_API FSlider : public GUIComponentWithOutput{
    ...
    struct ICL_QT_API Int : public GUIComponentWithOutput{
    ...
    struct ICL_QT_API Float : public GUIComponentWithOutput{
    ...
    struct ICL_QT_API String : public GUIComponent{
    ...
    struct ICL_QT_API Disp : public GUIComponent{
    ...
    struct ICL_QT_API Image : public GUIComponent{
      /// constructor
    ...
    struct ICL_QT_API Draw : public GUIComponent{
    ...
    struct ICL_QT_API Draw3D : public GUIComponent{
    ...
    struct ICL_QT_API Plot : public GUIComponent{
      private:
      /// utility method
    ...
    struct ICL_QT_API Combo : public GUIComponent{
      private:
      /// utility method
    ...
    struct ICL_QT_API Spinner : public GUIComponentWithOutput{
    ...
    /** create an FpsHandle that must be explicitly re-rendered in every loop-cycle of the 
        FPS-monitored loop */
    struct ICL_QT_API Fps : public GUIComponent{
    ...
    */
    struct ICL_QT_API CamCfg : public GUIComponent{
      private:
      /// utility method
    ...
    struct ICL_QT_API Prop : public GUIComponent{
    ...
    struct ICL_QT_API ColorSelect : public GUIComponentWithOutput{

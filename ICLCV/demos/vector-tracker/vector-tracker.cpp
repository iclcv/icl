...
**                                                                 **
** File   : ICLCV/demos/vector-tracker/vector-tracker.cpp          **
** Module : ICLCV                                                  **
...
void run(){
  ...
  w->color(255,255,255);
  char buf[400];
  snprintf(buf,sizeof(buf),"blobs:%4d frames:%6d Error-frames:%4d Errors:%4d   ",(unsigned int)vVT.size(),frame_counter,error_frames,error_counter);

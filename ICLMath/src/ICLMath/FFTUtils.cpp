...
#undef ICL_INSTANTIATE_DEPTH
	...
	if(n==1){
      ...
      template icl32c*  fft(unsigned int n, const icl8u* a);
      template icl32c*  fft(unsigned int n, const icl16u* a);
      template icl32c*  fft(unsigned int n, const icl32u* a);
      template icl32c*  fft(unsigned int n, const icl16s* a);
      template icl32c*  fft(unsigned int n, const icl32s* a);
      ...
      template icl32c*  fft(unsigned int n, const icl32f* a);
      ...
      template icl32c*  fft(unsigned int n, const icl64f* a);
      template icl32c*  fft(unsigned int n, const icl32c* a);
      template std::complex<icl64f>*  fft(unsigned int n, const icl32c* a);
      template std::complex<icl64f>*  fft(unsigned int n, const std::complex<icl64f>* a);
      template icl32c*  fft(unsigned int n, const std::complex<icl64f>* a);
...
#include <mkl_dfti.h>
	...
	return d;
      ...
      template icl32c*  dft(unsigned int n, icl8u* src);
      template std::complex<icl64f>*  dft(unsigned int n, icl8u* src);
      template icl32c*  dft(unsigned int n, icl16u* src);
      template std::complex<icl64f>*  dft(unsigned int n, icl16u* src);
      template icl32c*  dft(unsigned int n, icl32u* src);
      template std::complex<icl64f>*  dft(unsigned int n, icl32u* src);
      template icl32c*  dft(unsigned int n, icl16s* src);
      template std::complex<icl64f>*  dft(unsigned int n, icl16s* src);
      template icl32c*  dft(unsigned int n, icl32s* src);
      template std::complex<icl64f>*  dft(unsigned int n, icl32s* src);

      template icl32c*  dft(unsigned int n, icl32f* src);
      template std::complex<icl64f>*  dft(unsigned int n, icl32f* src);
      template std::complex<icl64f>*  dft(unsigned int n, icl64f* src);
      template icl32c*  dft(unsigned int n, icl64f* src);
      template icl32c*  dft(unsigned int n, icl32c* src);
      template std::complex<icl64f>*  dft(unsigned int n, icl32c* src);
      template std::complex<icl64f>*  dft(unsigned int n, std::complex<icl64f>* src);
      template icl32c*  dft(unsigned int n, std::complex<icl64f>* src);
	...
	return tempMat;
      ...
      template icl32c*  ifft_cpp(unsigned int n, const icl8u* a);
      template icl32c*  ifft_cpp(unsigned int n, const icl16u* a);
      template icl32c*  ifft_cpp(unsigned int n, const icl32u* a);
      template icl32c*  ifft_cpp(unsigned int n, const icl16s* a);
      template icl32c*  ifft_cpp(unsigned int n, const icl32s* a);
      template icl32c*  ifft_cpp(unsigned int n, const icl32f* a);
      ...
      template icl32c*  ifft_cpp(unsigned int n, const icl32c* a);
      template std::complex<icl64f>*  ifft_cpp(unsigned int n, const icl32c* a);
      template std::complex<icl64f>*  ifft_cpp(unsigned int n, const std::complex<icl64f>* a);
      template icl32c*  ifft_cpp(unsigned int n, const std::complex<icl64f>* a);
	...
	return d;
      ...
      template icl32c*  idft(unsigned int n, icl8u* src);
      template std::complex<icl64f>*  idft(unsigned int n, icl8u* src);
      template icl32c*  idft(unsigned int n, icl16u* src);
      template std::complex<icl64f>*  idft(unsigned int n, icl16u* src);
      template icl32c*  idft(unsigned int n, icl16s* src);
      template std::complex<icl64f>*  idft(unsigned int n, icl16s* src);
      template icl32c*  idft(unsigned int n, icl32u* src);
      template std::complex<icl64f>*  idft(unsigned int n, icl32u* src);
      template icl32c*  idft(unsigned int n, icl32s* src);
      template std::complex<icl64f>*  idft(unsigned int n, icl32s* src);
      template icl32c*  idft(unsigned int n, icl32f* src);
      template std::complex<icl64f>*  idft(unsigned int n, icl32f* src);
      template std::complex<icl64f>*  idft(unsigned int n, icl64f* src);
      template icl32c*  idft(unsigned int n, icl64f* src);
      template icl32c*  idft(unsigned int n, icl32c* src);
      template std::complex<icl64f>*  idft(unsigned int n, icl32c* src);
      template std::complex<icl64f>*  idft(unsigned int n, std::complex<icl64f>* src);
      template icl32c*  idft(unsigned int n, std::complex<icl64f>* src);

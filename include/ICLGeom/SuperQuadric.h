...
/**
 * Class representing a superquadric. All paramter can be set and optimized independent
 * if necessary.
...
private:
	...
	static const double E_MIN = 0.01;
	///upper limit for e1 and e2
	static const double E_MAX = 2.0;
	///lower limit for a1,a2,a3
	static const double A_MIN = 0.01;

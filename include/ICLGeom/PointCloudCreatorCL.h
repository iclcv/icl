...
**                                                                 **
** File   : include/ICLGeom/PointCloudCreatorCL.h                  **
** Module : ICLGeom                                                **
  ...
  namespace geom{
    ...
    class PointCloudCreatorCL{
     ...
     public:
      ...
      PointCloudCreatorCL(utils::Size size, const utils::Array2D<Vec3> &dirs); 
      ...
      ~PointCloudCreatorCL();
  	  ...
  	  void create(bool NEEDS_RAW_TO_MM_MAPPING,const core::Img32f *depthValues, 
                           ...
                           DataSegment<float,3> xyz, const utils::Array2D<Vec3> &dirs, float depthScaling);
      ...
      void createRGB(bool NEEDS_RAW_TO_MM_MAPPING,const core::Img32f *depthValues, const Mat M, 
                           ...
                           const core::Img8u *rgbIn,const utils::Array2D<Vec3> &dirs, float depthScaling);

...
private:
	...
	void buildTree(std::vector<DynMatrix<double> > &list,unsigned int depth, Node *node);
	///internal call to fill the KDTree with data
	void buildTree(std::vector<DynMatrix<double> *> &list,unsigned int depth, Node *node);
	///internal call to sort list by dimension of the vector (unused, instead std::sort)
	void sortList(std::vector<DynMatrix<double> > &list, unsigned int dim);
	///internal call to sort list by dimension of the vector (unused, instead std::sort)
	void sortList(std::vector<DynMatrix<double>* > &list, unsigned int dim);
...
public :
	 ...
	 */
	KDTree(std::vector<DynMatrix<double> > &list);
	///Constructor
	///Constructor
	/** Creates a new KDTree object, with data from list.
	 * @param list list of points for  the kd-tree
	 ...
	 * @param list list of points for the kd-tree
	 */
	void buildTree(std::vector<DynMatrix<double> *> &list){
		releaseTree();
	...
	DynMatrix<double>* nearestNeighbour(DynMatrix<double> &point);

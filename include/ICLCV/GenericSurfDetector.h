...
**                                                                 **
** File   : include/ICLCV/GenericSurfDetector.h                    **
** Module : ICLCV                                                  **
...
namespace icl{
  namespace cv{
    ...
    /** The class uses OpenCVSurfDetector or OpenSurfDetector
    ...
    class GenericSurfDetector{
      ...
      /** Uses the OpenCVSurfDetector for detection  of features.
          ...
          @param octavelayer
          */
      GenericSurfDetector(const core::ImgBase *obj=0,double threshold=500, int extended=1,
      ...
      /** Uses OpenSurfDetector for detection of features.
          ...
          */
      GenericSurfDetector(const core::ImgBase *obj=0,  bool upright=false, int octaves=4,
      ...
      struct GenericPointImpl{
        ...
        /// Feature center
        virtual utils::Point32f getCenter() const;
      ...
      ///Generic utils::Point structure, that is used for the GenericSurfDetector
      /** Internally, the SmartPtr 'impl' is set up with either an OpenCV or
          ...
          other methods (those that throw and utils::ICLException) are only available
          for either an opencv or an opensurf backend. */
      struct GenericPoint{
        ///Smartpointer holding the implementation of the point
        utils::SmartPtr<GenericPointImpl> impl;
        ///Contructor
        GenericPoint(){}
      ...
      GenericPoint(GenericPointImpl* i):impl(i){}
        ...
        utils::Point32f getCenter() const { return impl->getCenter(); }
        ...
        /** Using this function on OpenCVGenericPointImpl, forces an Exception.
            @return the scale */
        virtual float getScale() const throw (utils::ICLException){ return impl->getScale(); }
        ...
        /** An exception is thrown using this on OpenCVGenericPointImpl.
            ...
            */
        const float* getDescriptor() const throw (utils::ICLException){ return impl->getDescriptor(); }
        
        ///Return the pointmotion of the feature (opensurf only)
        /** An exception is thrown using this on OpenCVGenericPointImpl.
            @return pointmotion of the feature
            */
        float getDx() const throw (utils::ICLException){ return impl->getDx(); }
        ...
        /** An exception is thrown using this on OpenCVGenericPointImpl.
            @return pointmotion of the feature
            */
        float getDy() const throw (utils::ICLException){ return impl->getDy(); }
        
        ///Return the clusterindex of the feature (opensurf only)
        /** An exception is thrown using this on OpenCVGenericPointImpl.
            @return clusterindex of the feature
            */
        int getClusterIndex() const throw (utils::ICLException){ return impl->getClusterIndex(); }
        ...
        /** An exception is thrown using this on OpenSurfGenericPointImpl.
            ...
            */
        int getSize() const throw (utils::ICLException){ return impl->getSize(); }
  
        ///Return the hessian of the feature (opencv only)
        /** An exception is thrown using this on OpenSurfGenericPointImpl.
            @return hessian of the feature */
        float getHessian() const throw (utils::ICLException){ return impl->getHessian(); }
      };
      ...
      utils::SmartPtr<core::ImgBase> getObjectImg() throw (utils::ICLException);
      ...
      /** Throws Exception if opencv is used, since this function is only for opencv.
  	  @param upright */
      void setRotationInvariant(bool upright) throw (utils::ICLException);
      ...
      /** Throws Exc eption if opensurf is used, since this function is only for opencv.
          @param extended */
      void setExtended(int extended) throw (utils::ICLException);
      ...
      bool getRotationInvariant() throw (utils::ICLException);
      ...
      int getInitSamples() throw (utils::ICLException);
      ...
      /** @return extended */
      int getExtended() throw (utils::ICLException);
      ...
      const std::vector<GenericPoint> &extractFeatures(const core::ImgBase *src) throw (utils::ICLException);
      ...
      const std::vector<Match> &match(const core::ImgBase *image) throw (utils::ICLException);
      ...
      static void visualizePoint(utils::VisualizationDescription &target, const GenericPoint &p);

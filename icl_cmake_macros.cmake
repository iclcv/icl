...
macro(icl_check_external_package ID FFILE REL_LIB_DIR REL_INC_DIR DEFAULT_PATH DEFINE_COND)
	...
	find_path(${ID}_PATH "${FFILE}" "${DEFAULT_PATH}/${REL_INC_DIR}" DOC "The path to ${ID}")
	#message(STATUS "o: ${${ID}_PATH}  ${DEFAULT_PATH}/${REL_INC_DIR}")
	if(${${ID}_PATH} STREQUAL "${DEFAULT_PATH}/${REL_INC_DIR}")
		set(${ID}_PATH "${DEFAULT_PATH}")
		#message(STATUS "oknnn ${${ID}_PATH}")	
	else()
		#message(STATUS "not good")
		set(${ID}_PATH FALSE)
	endif()
	...
	if(${ID}_PATH)
		#set(${ID}_PATH "${DEFAULT_PATH}")
		#message(STATUS "ohoh:${${ID}_PATH}  ${CMAKE_include_directories}")

...
macro(icl_check_external_package ID FFILE REL_LIB_DIR REL_INC_DIR DEFAULT_PATH DEFINE_COND)
  ...
  if(NOT "${${ID}_PATH}" STREQUAL "${ID}_PATH-NOTFOUND")
    #set(CMAKE_REQUIRED_INCLUDES " ")
    check_include_file("${FFILE}" ${ID}_HEADER_FOUND "-I${${ID}_PATH}/${REL_INC_DIR}")
    #set(CMAKE_REQUIRED_INCLUDES "")
  endif()
  
  if(NOT ${ID}_HEADER_FOUND)
    message(STATUS "result: ${FFILE} was not found")
  else()

    file(GLOB ${ID}_HDRS "${${ID}_PATH}/${REL_INC_DIR}/${FFILE}")#/${REL_INC_DIR}")

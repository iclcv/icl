...
// {{{ convert,set, and copy channels using IPP#define CONVERT_8U32F(S,SC,D,DC) ippiConvert_8u32f_C1R(S->ippData8u(SC),S->ippStep(),D->ippData32f(DC),D->ippStep(),D->ippRoiSize())#define CONVERT_32F8U(S,SC,D,DC) ippiConvert_32f8u_C1R(S->ippData32f(SC),S->ippStep(),D->ippData8u(DC),D->ippStep(),D->ippRoiSize(),ippRndZero)   #define SET_32F(V,D,DC) ippiSet_32f_C1R(V,D->ippData32f(DC),D->ippStep(),D->ippRoiSize());#define SET_8U(V,D,DC) ippiSet_8u_C1R(V,D->ippData8u(DC),D->ippStep(),D->ippRoiSize());#define COPY_8U(S,SC,D,DC) ippiCopy_8u_C1R(S->ippData8u(SC),S->ippStep(),D->ippData8u(DC),D->ippStep(),D->ippRoiSize())  #define COPY_32F(S,SC,D,DC) ippiCopy_32f_C1R(S->ippData32f(SC),S->ippStep(),D->ippData32f(DC),D->ippStep(),D->ippRoiSize())  // }}}
#else
...
void convertFromRGB8(ICLBase *poDstImage, ICLBase *poSrcImage){
...
void convertFromRGB32(ICLBase *poDstImage, ICLBase *poSrcImage){

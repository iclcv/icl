...
\item \textbf{The Image class:}\\ Some functionalities are implemented as member functions, however most others are not. Here the ICL's image class interface \iclclassref{Core}{ImgBase} \iclclassref{Core}{Img} is discussed.

...
\item The \icode{StackTimer} (\iclclassref{Utils}{StackTimer}) can be used with the macro \icode{BENCHMARK\_THIS\_FUNCTION} to profile a function.
...
\subsubsection{Example: Arithmetical Operations}

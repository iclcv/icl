...
This function \emph{applies} the operators functionality on the input image \inlinecode{src} and stores the result in the output image \inlinecode{dst}. All ICL-operators will adapt the output image automatically in terms of size, channel count, format and even depth. 

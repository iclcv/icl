...
function(CONFIGURE_GTEST library_name library_root)
  ...
  target_link_libraries(${TEST_TARGET_NAME} GTest::GTest ${library_name})
  gtest_discover_tests(${TEST_TARGET_NAME} TEST_PREFIX ${library_lower})
  add_dependencies(tests ${TEST_TARGET_NAME})
  add_test(${TEST_TARGET_NAME} COMMAND ${CMAKE_BINARY_DIR}/${library_name}/${TEST_TARGET_NAME})
  # SETUP_TARGET_FOR_COVERAGE(NAME ${TEST_TARGET_NAME}_coverage

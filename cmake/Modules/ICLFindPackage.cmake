...
MACRO(ICL_FIND_PACKAGE)
  ...
  FOREACH(_LIB ${_PKG_LIBS})
    FIND_LIBRARY(${_PKG_NAME_UPPER}_${_LIB}_LIBRARY
      NAMES ${_LIB}
      PATHS ${_PKG_SEARCH_PATHS}
      PATH_SUFFIXES "lib" ${ARCH_DEPENDENT_LIB_PATHS} ${_PKG_LIB_PATH_SUFFIXES}
      NO_DEFAULT_PATH)

    IF(NOT ${_PKG_NAME_UPPER}_${_LIB}_LIBRARY)
      LIST(APPEND _PKG_MISSING ${_PKG_NAME_UPPER}_${_LIB}_LIBRARY)
    ELSE()
      LIST(APPEND ${_PKG_NAME_UPPER}_LIBRARIES ${${_PKG_NAME_UPPER}_${_LIB}_LIBRARY})
    ENDIF()
  ENDFOREACH()

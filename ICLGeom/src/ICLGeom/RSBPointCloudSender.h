...
namespace icl{
  namespace geom{
    ...
    class RSBPointCloudSender : public PointCloudOutput{
      struct Data;
      Data *m_data;

      public:
      RSBPointCloudSender(const RSBPointCloudSender&) = delete;
      RSBPointCloudSender& operator=(const RSBPointCloudSender&) = delete;

...
void icl::geom::ShaderUtil::recompilePerPixelShader(icl::qt::GLFragmentShader** shaders, const icl::utils::SmartPtr<icl::geom::SceneLight>* lights, int numShadowLights) {
  ...
  shaders[ShaderUtil::SHADOW] = new icl::qt::GLFragmentShader( vertexBuffer.str(), "#define RENDER_SHADOW\n" + fragmentBuffer.str());
  shaders[ShaderUtil::SHADOW_TEXTURE] = new icl::qt::GLFragmentShader( vertexBuffer.str(), "#define USE_TEXTURE;\n#define RENDER_SHADOW\n" + fragmentBuffer.str());
  shaders[ShaderUtil::NO_SHADOW] = new icl::qt::GLFragmentShader( vertexBuffer.str(), fragmentBuffer.str());
  shaders[ShaderUtil::NO_SHADOW_TEXTURE] = new icl::qt::GLFragmentShader( vertexBuffer.str(), "#define USE_TEXTURE;\n" + fragmentBuffer.str());
}

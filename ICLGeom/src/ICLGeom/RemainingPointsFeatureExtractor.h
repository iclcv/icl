    ...
    class RemainingPointsFeatureExtractor{
      ...
      /** @param xyz the input xyz pointcloud data segment
        ...
        static void apply(core::DataSegment<float,4> &xyz, const core::Img32f &depthImage, core::Img32s &labelImage, core::Img8u &maskImage, 
                          std::vector<std::vector<int> > &surfaces, std::vector<std::vector<int> > &segments, int minSize=10, float euclideanDistance=5., int radius=6);
      ...
      /** @param xyz the input xyz pointcloud data segment
        ...
        static void apply(core::DataSegment<float,4> &xyz, core::Img32s &labelImage, core::Img8u &maskImage, 
                          std::vector<std::vector<int> > &surfaces, std::vector<std::vector<int> > &segments, int minSize=10, float euclideanDistance=5.);
      ...
      /** @param xyz the input xyz pointcloud data segment
        ...
        static math::DynMatrix<bool> apply(core::DataSegment<float,4> &xyz, const core::Img32f &depthImage, core::Img32s &labelImage, core::Img8u &maskImage, 
                          std::vector<std::vector<int> > &surfaces, int minSize=10, float euclideanDistance=5., int radius=6);
      ...
      /** @param xyz the input xyz pointcloud data segment
        ...
        static math::DynMatrix<bool> apply(core::DataSegment<float,4> &xyz, core::Img32s &labelImage, core::Img8u &maskImage, 
                          std::vector<std::vector<int> > &surfaces, int minSize=10, float euclideanDistance=5.);
      ...
      private:
        ...
        static void ruleBasedAssignment(core::DataSegment<float,4> &xyz, std::vector<std::vector<int> > &surfaces, std::vector<std::vector<int> > &segments, 

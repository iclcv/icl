...
.. literalinclude:: examples/gui-apps-2.cpp
   :language: c++                         
   :linenos:                              
...
libjepg (**TODO:** perhaps this will become mandatory?), you can run
...
**GenericGrabber**, this enables you to create applications that are able
to work with arbitrary image sources. Some examples are given below.
...
.. [#f3] needs ICL built with opencv support

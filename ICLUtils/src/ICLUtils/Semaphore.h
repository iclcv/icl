...
namespace icl{
  namespace utils{
    ...
    /** \cond */
    class ICL_UTILS_EXP SemaphoreImpl;
    class ICL_UTILS_EXP SemaphoreImplDelOp{
    ...
    class ICL_UTILS_EXP Semaphore : public ShallowCopyable<SemaphoreImpl, SemaphoreImplDelOp>{
      public:

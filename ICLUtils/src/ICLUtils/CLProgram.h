...
namespace icl {
  namespace utils {
    ...
    class ICLUtils_API CLProgram {
	  ...
	  CLProgram(const CLDeviceContext &device_context, const std::string &sourceCode);

	  CLProgram(const CLDeviceContext &device_context, std::ifstream &fileStream);

      /// create CLProgram with given device type (either "gpu" or "cpu") and souce-code
	  CLProgram(const std::string &deviceType, const std::string &sourceCode);

      /// create CLProgram with given device type (either "gpu" or "cpu") and souce-code file
	  CLProgram(const std::string &deviceType, std::ifstream &fileStream);

	  /// create CLProgram with given cl-program parent and souce-code
	  CLProgram(const std::string &sourceCode, const CLProgram &parent);

	  /// create CLProgram with given cl-program parent and souce-code file
	  CLProgram(std::ifstream &fileStream, const CLProgram &parent);
      ...
      CLBuffer createBuffer(const std::string &accessMode, size_t size,const void *src=0);
      ...
      /** acessMode can either be "r", "w" or "rw", which refers to the readibility of the data
          ...
          */
      CLImage2D createImage2D(const std::string &accessMode, const size_t width, const size_t height, int depth, const void *src=0);

	  CLImage2D createImage2D(const std::string &accessMode, const size_t width, const size_t height, int depth, int num_channel, const void *src=0);

...
namespace icl {
	namespace utils {
		...
		public:
			 ...
			 * @return
			 */
			CLBuffer createBuffer(const std::string &accessMode, size_t length, size_t byteDepth, const void *src = 0);
		...
		private:
			 ...
			 * Throws a CLBufferException in case of allocation problems.\n
			 */
			CLBuffer *createBufferHeap(const std::string &accessMode, size_t length, size_t byteDepth, const void *src=0);
			 ...
			 * Throws a CLBufferException in case of allocation problems.\n
			 */
			CLImage2D *createImage2DHeap(const std::string &accessMode, const size_t width, const size_t height, int depth, int num_channel, const void *src=0);
		};

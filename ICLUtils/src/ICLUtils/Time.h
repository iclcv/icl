    ...
    class ICL_UTILS_EXP Time {
      ...
      // No copy constructor and assignment operator necessary. The
        ...
        **/
        ...
        friend ICL_UTILS_EXP std::ostream& operator<<(std::ostream&, const Time&);
  
        friend ICL_UTILS_EXP std::istream& operator>>(std::istream&, Time&);
     ...
     ICL_UTILS_EXP std::ostream& operator<<(std::ostream&, const Time&);
  
     /// reads Time instances value type from the stream
     ICL_UTILS_EXP std::istream& operator>>(std::istream&, Time&);

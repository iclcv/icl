...
/// todo
    ...
    static void Xor (const Img32f *src1, const Img32f *src2, Img32f *dst);
		...
		static void And (const ImgI *poSrc1, const ImgI *poSrc2, ImgI **ppoDst);
		static void Or (const ImgI *poSrc1, const ImgI *poSrc2, ImgI **ppoDst);
		static void Xor (const ImgI *poSrc1, const ImgI *poSrc2, ImgI **ppoDst);
		static void Not (const ImgI *poSrc, ImgI **ppoDst);
  };
} // namespace icl

...
**                                                                 **
** File   : ICLFilter/src/ICLFilter/NewUnaryCompareOp.cpp          **
** Module : ICLFilter                                              **
  ...
  namespace filter {
    ...
    namespace {
      ...
      void cmpTyped(const Img<T> &src, Img8u &dst, T value, int ot) {
        switch(ot) {
          case NewUnaryCompareOp::lt:   cmpLoop(src, dst, value, [](T a, T b){ return a < b; }); break;
          case NewUnaryCompareOp::lteq: cmpLoop(src, dst, value, [](T a, T b){ return a <= b; }); break;
          case NewUnaryCompareOp::eq:   cmpLoop(src, dst, value, [](T a, T b){ return a == b; }); break;
          case NewUnaryCompareOp::gteq: cmpLoop(src, dst, value, [](T a, T b){ return a >= b; }); break;
          case NewUnaryCompareOp::gt:   cmpLoop(src, dst, value, [](T a, T b){ return a > b; }); break;
          default: break;
        }
      }
    ...
    NewUnaryCompareOp::NewUnaryCompareOp(optype ot, icl64f value, icl64f tolerance)
      : m_eOpType(ot), m_dValue(value), m_dTolerance(tolerance)
    {
      initDispatching("NewUnaryCompareOp");
    ...
    void NewUnaryCompareOp::apply(const Image &src, Image &dst) {

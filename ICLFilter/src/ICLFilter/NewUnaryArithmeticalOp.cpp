...
**                                                                 **
** File   : ICLFilter/src/ICLFilter/NewUnaryArithmeticalOp.cpp     **
** Module : ICLFilter                                              **
...
namespace icl {
  namespace filter {
    ...
    namespace {
      using Op = NewUnaryArithmeticalOp;
    ...
    NewUnaryArithmeticalOp::NewUnaryArithmeticalOp(optype t, icl64f val)
      : m_eOpType(t), m_dValue(val)
    {
      initDispatching("NewUnaryArithmeticalOp");
    ...
    void NewUnaryArithmeticalOp::apply(const Image &src, Image &dst) {

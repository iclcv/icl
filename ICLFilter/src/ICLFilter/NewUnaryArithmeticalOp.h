...
**                                                                 **
** File   : ICLFilter/src/ICLFilter/NewUnaryArithmeticalOp.h       **
** Module : ICLFilter                                              **
...
namespace icl {
  namespace filter {
    ...
    class ICLFilter_API NewUnaryArithmeticalOp : public UnaryOp, public core::Dispatching {
      public:
      ...
      NewUnaryArithmeticalOp(optype t = addOp, icl64f val = 0);

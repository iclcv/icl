...
namespace icl{
  ...
  /**
  Compares pixel values of two images or of one image and a Constant 
  using a specified compare operation and writes the results to an Img8u image . 
  If the result of the comparison is true, the corresponding output pixel 
  is set to 255; otherwise, it is set to 0.
   */
  class Compare {
  public:
